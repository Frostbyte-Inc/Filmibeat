...
import arunkbabu90.filimibeat.databinding.ActivityAccountVerificationBinding;
import arunkbabu90.filimibeat.ui.fragment.VerificationEmailFragment;

public class AccountVerificationActivity extends AppCompatActivity {

    private MaterialButton mNextButton; /* Retry button */
    private MaterialTextView mCountdownTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityAccountVerificationBinding binding = ActivityAccountVerificationBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        mNextButton = binding.btnAccountVerificationNext;
        mCountdownTextView = binding.tvAccountVerificationCountdown;
