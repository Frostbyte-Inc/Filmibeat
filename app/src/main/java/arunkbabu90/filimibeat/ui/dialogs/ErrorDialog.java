package arunkbabu90.filimibeat.ui.dialogs;
...
import arunkbabu90.filimibeat.databinding.DialogErrorBinding;

public class ErrorDialog extends DialogFragment {
    private DialogErrorBinding binding;

    private MaterialTextView mMessageTextView;
    ...
    private final String mNegativeButtonLabel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mMessageTextView = binding.tvErrorDialogMessage;
        mNegativeButton = binding.tvErrorDialogNegative;
        mPositiveButton = binding.tvErrorDialogPositive;
