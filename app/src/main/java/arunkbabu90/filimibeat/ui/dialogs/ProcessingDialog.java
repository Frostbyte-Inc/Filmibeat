...
import arunkbabu90.filimibeat.databinding.DialogProcessingBinding;
...
public class ProcessingDialog extends DialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mMessageTextView = binding.tvProcessingDialogMessage;
        mButton = binding.tvProcessingDialogButton;
