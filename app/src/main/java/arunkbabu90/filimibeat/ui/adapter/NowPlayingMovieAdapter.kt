...
class NowPlayingMovieAdapter(private val itemClickListener: (MovieNowPlaying?) -> Unit)
    : PagedListAdapter<MovieNowPlaying, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    class MovieViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(movie: MovieNowPlaying?, itemClickListener: (MovieNowPlaying?) -> Unit) {
    ...
    class MovieDiffCallback : DiffUtil.ItemCallback<MovieNowPlaying>() {
        override fun areItemsTheSame(oldItem: MovieNowPlaying, newItem: MovieNowPlaying): Boolean
                = oldItem.movieId == newItem.movieId

        override fun areContentsTheSame(oldItem: MovieNowPlaying, newItem: MovieNowPlaying): Boolean
                = oldItem == newItem
    }
}